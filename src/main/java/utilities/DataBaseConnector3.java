...
public class DataBaseConnector3 {

    private static final String dbusername = ConfigurationReader.getProperty("dbusername");
    private static final String dbpassword = ConfigurationReader.getProperty("dbpassword");
